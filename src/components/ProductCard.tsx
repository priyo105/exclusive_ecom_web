...
const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
  return (
    <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden w-full max-w-sm flex flex-col hover:shadow-lg transition-all duration-200 group transform hover:scale-110">
      <div className="relative bg-gray-100 h-48 flex items-center justify-center">
        ...
        />
        <button className="absolute top-3 right-3 bg-white rounded-full p-2 shadow-md border border-gray-200 hover:bg-gray-100 transition-all">
      ...
      <div className="p-4 flex flex-col gap-2 flex-1">
        ...
        <button className="mt-3 bg-white border border-gray-300 hover:bg-black hover:text-white text-black font-semibold py-2 rounded-full transition-all w-full shadow-sm">
          Add to Cart
        </button>
      </div>
    </div>
